...
Example:
	simappd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "simappd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "simappcli",
...
func InitTestnet(
	...
	for i := 0; i < numValidators; i++ {
		...
		gaiaConfigFilePath := filepath.Join(nodeDir, "config/simappd.toml")
